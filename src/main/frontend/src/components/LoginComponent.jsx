        ...
        return (
            ...
            <div>
                ...
                <Stack orientation="column">
                    ...
                    <span style={{margin: "auto", fontSize: 40, marginTop: 80, fontFamily: "dm-700"}}>Connexion</span>
                    <form style={{margin: "auto"}} onSubmit={this.handleSubmit}>
                        ...
                        <input style={{marginLeft: 10}} type="password" id="password" name="password" onChange={this.handlePasswordChange} required/>

                        <input style={{marginLeft: 10}} type="submit" value="Connexion"></input>
                    </form>
                    <span style={{margin: "auto",marginTop: 10}}>Pas encore de compte ? <Link to="/signup">S'inscrire</Link></span>
                </Stack>
            </div>
        );
    }
